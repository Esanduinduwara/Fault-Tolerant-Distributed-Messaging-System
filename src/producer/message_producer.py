...
=============================================================================
 ...
 File: src/producer/message_producer.py
 Grading Part 1 (20%)
=============================================================================
...
GIT COMMIT MESSAGE TEMPLATES (copy-paste these exactly)
---------------------------------------------------------
Day 1:  "feat(producer): add FaultTolerantProducer class with Kafka init (acks=all, retries=10)"
Day 2:  "feat(producer): implement Dead Letter Queue fallback for unreachable Kafka broker"
Day 3:  "feat(producer): implement send_message() with ms timestamp and partition key"
Day 4:  "feat(producer): add send_batch() for scalability and safe close() teardown"
Day 5:  "feat(producer): integrate HLC timestamps and finalize fault tolerance producer"
=============================================================================
"""

# ─────────────────────────────────────────────────────────────────────────────
# DAY 1  ▸  PUSH THIS BLOCK FIRST
